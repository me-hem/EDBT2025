...
features = ['gasUsed','gasPrice','maxFeePerGas','maxPriorityFeePerGas','baseFees','value','voteCount','activeValidators']  # Adjust to your actual feature columns
target = 'priorityFee'
...
results.to_csv('results(priorityFee).csv', index=False)